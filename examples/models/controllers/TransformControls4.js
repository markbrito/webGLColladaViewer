...
/*			XYZ: [
			...
			XY: [
				[ new THREE.Mesh( new THREE.PlaneBufferGeometry( 0.29, 0.29 ), new GizmoMaterial( { color: 0xffff00, opacity: 0.25 } ) ), [ 0.415, 0.415, 0 ] ]
			],

			YZ: [
				[ new THREE.Mesh( new THREE.PlaneBufferGeometry( 0.29, 0.29 ), new GizmoMaterial( { color: 0x00ffff, opacity: 0.25 } ) ), [ 0, 0.415, 0.415 ], [ 0, Math.PI / 2, 0 ] ]
			],

			XZ: [
				[ new THREE.Mesh( new THREE.PlaneBufferGeometry( 0.29, 0.29 ), new GizmoMaterial( { color: 0xff00ff, opacity: 0.25 } ) ), [ 0.415, 0, 0.415 ], [ - Math.PI / 2, 0, 0 ] ]
			]
*/
...
/*			XYZ: [
			...
			XY: [
				[ new THREE.Mesh( new THREE.PlaneBufferGeometry( 0.29, 0.29 ), pickerMaterial ), [ 0.42, 0.42, 0 ] ]
			],

			YZ: [
				[ new THREE.Mesh( new THREE.PlaneBufferGeometry( 0.2964, 0.2964 ), pickerMaterial ), [ 0, 0.42, 0.42 ], [ 0, Math.PI / 2, 0 ] ]
			],

			XZ: [
				[ new THREE.Mesh( new THREE.PlaneBufferGeometry( 0.2964, 0.2964 ), pickerMaterial ), [ 0.42, 0, 0.42 ], [ - Math.PI / 2, 0, 0 ] ]
			]
*/
	...
	THREE.TransformGizmoScale = function () {
		...
		this.handleGizmos = {
			...
			XYZ: [
				[ new THREE.Mesh( new THREE.BoxGeometry( 0.84125, 0.84125, 0.84125 ), new GizmoMaterial( { color: 0xffffff, opacity: 0.25 } ) ) ]
			]
		...
		this.pickerGizmos = {
			...
			XYZ: [
				[ new THREE.Mesh( new THREE.BoxGeometry( 0.84, 0.84, 0.84 ), pickerMaterial ) ]
			]
